# Code adapted from https://github.com/facebookresearch/fvcore/blob/main/fvcore/common/registry.py
    ...
    def register(self, obj: Any = None) -> Any:
        ...
        if obj is None:
            ...
            def deco(func_or_class: Any) -> Any:
                inner_name = func_or_class.__name__
                self._do_register(inner_name, func_or_class)
